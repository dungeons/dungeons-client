 ...
 * {@link SpriteRenderer#begin()} method which will setup appropriate render
 * states. When you are done with drawing you have to call
 * {@link SpriteRenderer#end()} which will actually draw the things you
 * specified.
 * </p>
 * 
 * <p>
...
public class SpriteRenderer implements Disposable {
     ...
     * shader. See {@link #SpriteRenderer(int, ShaderProgram)}.
     */
     ...
     * {@link #SpriteRenderer(int, int, ShaderProgram)}.
     */
    ...
    public SpriteRenderer(int size, int buffers, ShaderProgram defaultShader) {
        ...
        for (int i = 0; i < buffers; i++) {
            this.buffers[i] = new Mesh(VertexDataType.VertexArray, false, size * 4, size * 6, new VertexAttribute(Usage.Position, 3,
                    ShaderProgram.POSITION_ATTRIBUTE), new VertexAttribute(Usage.ColorPacked, 4, ShaderProgram.COLOR_ATTRIBUTE), new VertexAttribute(
     ...
     * {@link #getColor()} from the SpriteBatch is not applied.
     */
